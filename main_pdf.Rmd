...
```{stan stan_params, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
data {
...
```{stan stan_forward, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
...
```{stan stan_forward_norm, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
...
```{stan stan_forwardbackward, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
functions {
...
```{stan stan_viterbi, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
generated quantities {
...
```{stan stan_estimation, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
model {
...
```{stan iohmm_params, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
data {
  int<lower=1> T;                   // number of observations (length)
  int<lower=1> K;                   // number of hidden states
...
```{stan iohmm_forward, cache = FALSE, echo = TRUE, eval = FALSE, output.var = "TRASH"}
transformed parameters {
  vector[K] logalpha[T];
