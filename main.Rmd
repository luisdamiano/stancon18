---
title: "A primer on Hidden Markov Models using Stan"
author: "Luis Damiano"
date: "`r Sys.Date()`"
output:
...
_A primer on Hidden Markov Models using Stan_ is licensed under CC-BY-SA 4.0. See the [LICENSE](LICENSE.md) file for details. All files are available in the [stancon18-hmm](https://github.com/luisdamiano/) GitHub repository.
...
Once adjusted the transition probability matrix, the Stan code for the forward-backward algorithm suffers no modification with respect to the code for the HMM.

### MAP: Viterbi

The Stan code for the Viterbi encoding algorithm suffers no modification with respect to the code for the HMM.
...
We rely on several diagnostic statistics and plots provided by rstan [@sdt2017rstan] and shinystan [@sdt2017shinystan] to assess mixing, convergence and the inexistence of divergences. Label switching hinders the comparison between true and observed parameters.
