...
_A primer on Hidden Markov Models using Stan_ is licensed under CC-BY-SA 4.0. See the [LICENSE](LICENSE.md) file for details. All files are available in the [stancon18-hmm](https://github.com/luisdamiano/stancon18) GitHub repository.
