...
\NormalTok{hmm_init <-}\StringTok{ }\NormalTok{function(K, x_t) \{}
  ...
  \KeywordTok{list}\NormalTok{(}
    ...
    \DataTypeTok{sigma_k =} \NormalTok{init.sigma[init.order]}
  \NormalTok{)}
\NormalTok{\}}
...
\NormalTok{iohmm_generate <-}\StringTok{ }\NormalTok{function(T) \{}
  ...
  \NormalTok{for (t in }\DecValTok{2}\NormalTok{:T) \{}
    \NormalTok{p.mat[t, ] <-}\StringTok{ }\KeywordTok{softmax}\NormalTok{(}\KeywordTok{sapply}\NormalTok{(}\DecValTok{1}\NormalTok{:K, function(j) \{u_tm[t, ] %*%}\StringTok{ }\NormalTok{w_km[j, ]\}))}
  ...
  \NormalTok{x_t <-}\StringTok{ }\KeywordTok{vector}\NormalTok{(}\StringTok{"numeric"}\NormalTok{, T)}
  \NormalTok{for (t in }\DecValTok{1}\NormalTok{:T) \{}
    \NormalTok{x_t[t] <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{1}\NormalTok{, u_tm[t, ] %*%}\StringTok{ }\NormalTok{b_km[z_t[t], ], sigma_k[z_t[t]])}
  \NormalTok{\}}
